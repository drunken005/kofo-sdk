const CONSTANT = {
    ...
    GATEWAY_PATH: {
        BALANCE: "/balance",
        CREATE_APPROVE_TX: "/kofo/create_approve_tx",
        SEND_APPROVE_TX: "/kofo/send_approve_tx",
        CREATE_LOCK_TX: "/kofo/create_lock_tx",
        SEND_LOCK_TX: "/kofo/send_lock_tx",
        CREATE_WITHDRAW_TX: "/kofo/create_withdraw_tx",
        SEND_WITHDRAW_TX: "/kofo/send_withdraw_tx",
        CREATE_REFUND_TX: "/kofo/create_refund_tx",
        SEND_REFUND_TX: "/kofo/send_refund_tx"
    }
};
