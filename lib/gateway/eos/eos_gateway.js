...
class EosGateway extends Connection {
    ...
    async sendLockTx({settlementId, lockId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD.EOS}) {
    ...
    async sendWithdrawTx({settlementId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD.EOS}) {
    ...
    async sendRefundTx({settlementId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD.EOS}) {
