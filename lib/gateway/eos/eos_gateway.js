...
class EosGateway extends Connection {
    ...
    async sendLockTx({settlementId, lockId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD}) {
    ...
    async sendWithdrawTx({settlementId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD}) {
    ...
    async sendRefundTx({settlementId, rawTransaction, signList, confirmThreshold = CONFIRM_THRESHOLD}) {
