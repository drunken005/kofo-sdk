...
class EthGateway extends Connection {
    ...
    async sendLockTx({settlementId, signedRawTransaction, lockId, confirmThreshold = CONFIRM_THRESHOLD.ETH}) {
    ...
    async sendWithdrawTx({settlementId, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.ETH}) {
    ...
    async sendRefundTx({settlementId, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.ETH}) {
    ...
    async sendApproveTx({settlementId, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.ETH}) {
