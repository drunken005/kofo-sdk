...
class ZilliqaGateway extends Connection {
    ...
    async sendLockTx({settlementId, signedRawTransaction, lockId, confirmThreshold = CONFIRM_THRESHOLD.ZILLIQA}) {
    ...
    async sendWithdrawTx({settlementId, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.ZILLIQA}) {
    ...
    async sendRefundTx({settlementId, signedRawTransaction, confirmThreshold = CONFIRM_THRESHOLD.ZILLIQA}) {
