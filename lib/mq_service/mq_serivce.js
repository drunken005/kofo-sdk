 ...
 */
class MqService {
    constructor({mqUrl, mqOptions}, event) {
        this.statusEvent = event;
        let {username, password, kofoId: clientId} = mqOptions;
        this.mqtt = Mqtt.connect(mqUrl, {username, password, clientId});
        this.kofoId = mqOptions.kofoId;
