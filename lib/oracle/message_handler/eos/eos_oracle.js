...
class EosOracle extends Oracle {
    ...
    async submitHashLockTxHandler(message) {
        ...
        const _self = this;
        _self.logger.info(`EOS ${roleEnum} submitHashLockTx ${settlementId}`);
    ...
    async submitWithdrawTxHandler(message) {
        ...
        _self.logger.info(`EOS ${roleEnum} submitWithdrawTx ${settlementId}`);
    ...
    async submitRefundTxHandler(message) {
        ...
        _self.logger.info(`EOS ${roleEnum} submitRefundTx ${settlementId}`);
