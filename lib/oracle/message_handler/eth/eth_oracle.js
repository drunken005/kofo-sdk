...
class EthOracle extends Oracle {
    ...
    async submitHashLockTxHandler(message) {
        ...
        const _self = this;
        _self.print(`ETH ${roleEnum} submitHashLockTx....................................`);
        ...
        if (!hasLocker) {
            try {
                ...
                await _self.settlementProvider.submitHashLockCallback(chain, roleEnum, settlementId, lockTx.lockId, lockTx.rawTransaction, txHash, lockTx.nLockNum, null);
                _self.insertData(submitHashLockTxLockerKey, true);
            ...
            _statusNotice_(NOTICE_TYPE.submitHashLock, {lockTx, lockTxHash: lockTxHash ? lockTxHash.txHash : null});
        }
    }
    ...
    async submitWithdrawTxHandler(message) {
        ...
        _self.print(`ETH ${roleEnum} submitWithdrawTx....................................`);
    ...
    async submitRefundTxHandler(message) {
        ...
        _self.print(`ETH ${roleEnum} submitRefundTx....................................`);
    ...
    async submitApproveTxHandler(message) {
        const {settlementId, roleEnum} = message;
        const _self = this;
        _self.print(`ETH Erc20 ${roleEnum} submitApproveTx....................................`);
        ...
        if (!hasLocker) {
            try {
                ...
                if (!hasApproveTx) {
                    ...
                    _statusNotice_(NOTICE_TYPE.preApprove, {approveTx})
                }
