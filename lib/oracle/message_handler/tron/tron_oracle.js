...
/**
 * Provides TRON settlement order message handler
 */
class TronOracle extends Oracle {
    constructor() {
    ...
    async submitHashLockTxHandler(message) {
        ...
        const _self = this;
        _self.logger.info(`TRON ${roleEnum} submitHashLockTx ${settlementId}`);
    ...
    async submitWithdrawTxHandler(message) {
        ...
        _self.logger.info(`TRON ${roleEnum} submitWithdrawTx ${settlementId}`);
    ...
    async submitRefundTxHandler(message) {
        ...
        _self.logger.info(`TRON ${roleEnum} submitRefundTx ${settlementId}`);
