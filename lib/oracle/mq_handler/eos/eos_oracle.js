...
class Eos_oracle extends Oracle {
    ...
    async makerSubmitHashLockTx(message) {
        ...
        if (!hasLocker) {
            try {
                ...
                await this.settlementProvider.makerSubmitHashLockCallback(message.chain, settlementId, lockTx.lockId, lockTx.rawTransaction, lockTxHash.txHash, null, lockTx.nlockDate);
    ...
    async takerSubmitHashLockTx(message) {
        ...
        const {takerChain, takerCurrency, hValue: hvalue, makerCounterChainPubKey: receiverPubKey, takerPubKey: senderPubKey, takerLocktime: lockTime, takerAmount: amount} = takerReceiveHAndCreateRefundTx;
        ...
        if (!hasLocker) {
            try {
                ...
                await this.settlementProvider.takerSubmitHashLockCallback(message.chain, settlementId, lockTx.lockId, lockTx.rawTransaction, lockTxHash.txHash, null, lockTx.nlockDate);
