...
class Eth_oracle extends Oracle {
    constructor() {
    ...
    async makerSubmitHashLockTx(message) {
        this.print('ETH makerSubmitHashLockTx....................................');
        ...
        if (!hasLocker) {
            try {
                ...
                await this.settlementProvider.makerSubmitHashLockCallback(message.chain, settlementId, lockTx.lockId, lockTx.rawTransaction, lockTxHash.txHash, lockTx.nLockNum, null);
    ...
    async takerSubmitHashLockTx(message) {
        this.print('ETH takerSubmitHashLockTx....................................')
        const {settlementId} = message;
        ...
        if (!hasLocker) {
            try {
                ...
                await this.settlementProvider.takerSubmitHashLockCallback(message.chain, settlementId, lockTx.lockId, lockTx.rawTransaction, lockTxHash.txHash, lockTx.nLockNum, null);
    ...
    async makerSubmitWithdrawTx(message) {
        this.print('ETH makerSubmitWithdrawTx....................................');
    ...
    async takerSubmitWithdrawTx(message) {
        this.print('ETH takerSubmitWithdrawTx....................................');
    ...
    async makerSubmitRefundTx(message) {
        this.print('ETH makerSubmitRefundTx....................................');
        const {settlementId} = message;
        ...
        const {makerChain, makerCurrency, makerPubKey} = makerCreateRefundTxAndH;
        ...
        if (!hasLocker) {
            try {
                ...
                let gatewayProvider = this.getGatewayProvider(makerChain, makerCurrency);
                let sender = this.publicToAddress(makerChain, makerCurrency, makerPubKey);
                if (!hashRefundTx) {
    ...
    async takerSubmitRefundTx(message) {
        this.print('ETH takerSubmitRefundTx....................................');
        const {settlementId} = message;
        ...
        const {takerChain, takerCurrency, takerPubKey} = takerReceiveHAndCreateRefundTx;
        ...
        if (!hasLocker) {
            try {
                ...
                let gatewayProvider = this.getGatewayProvider(takerChain, takerCurrency);
                let sender = this.publicToAddress(takerChain, takerCurrency, takerPubKey);
                if (!hashRefundTx) {
                    refundTx = await gatewayProvider.createRefundTx({
                        settlementId,
                        sender,
    ...
    async makerSubmitApproveTx(message) {
        this.print('ETH Erc20 makerSubmitApproveTx....................................');
        const {settlementId} = message;
    ...
    async takerSubmitApproveTx(message) {
        this.print('ETH Erc20 takerSubmitApproveTx....................................');
        const {settlementId} = message;
