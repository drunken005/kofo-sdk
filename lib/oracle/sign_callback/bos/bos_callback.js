 ...
 */
class BosSignatureCallback extends Oracle {
    ...
    async hashLockTxSignCallback(roleEnum, settlementId, signList) {
        const _self = this;
        _self.logger.info(`BOS ${roleEnum} ${settlementId} hashLockTxSign sign_callback params: `, signList);
    ...
    async withdrawTxSignCallback(roleEnum, settlementId, signList) {
        const _self = this;
        _self.logger.info(`BOS ${roleEnum} ${settlementId} withdrawTxSign sign_callback params: `, signList);
    ...
    async refundTxSignCallback(roleEnum, settlementId, signList) {
        const _self = this;
        _self.logger.info(`BOS ${roleEnum} ${settlementId} refundTxSignCallback sign_callback params: `, signList);
...
module.exports = BosSignatureCallback;