...
class EthSignatureCallback extends Oracle {
    ...
    async makerHashLockTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH makerHashLockTxSign sign_callback params: ', {settlementId, signedRawTransaction});
        ...
        try {
            let {lockId, rawTransaction, nLockNum} = this.readMakerData(keyMakerSubmitHashLockTx);
            ...
            await this.settlementProvider.makerSubmitHashLockCallback(chain, settlementId, lockId, rawTransaction, lockTxHash.txHash, nLockNum, null);
    ...
    async takerHashLockTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH takerHashLockTxSign sign_callback params: ', {settlementId, signedRawTransaction});
        ...
        try {
            let {lockId, rawTransaction, nLockNum} = this.readData(keyTakerSubmitHashLockTx);
            ...
            await this.settlementProvider.takerSubmitHashLockCallback(chain, settlementId, lockId, rawTransaction, lockTxHash.txHash, nLockNum, null);
    ...
    async makerWithdrawTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH makerWithdrawTxSign sign_callback params: ', {settlementId, signedRawTransaction});
    ...
    async takerWithdrawTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH takerWithdrawTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async makerRefundTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH makerRefundTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async takerRefundTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH takerRefundTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async makerApproveTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH Erc20 makerApproveTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async takerApproveTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH Erc20 takerApproveTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
