...
/**
 * Provides TRON with Hash lock, Withdraw, Refund, Approve signature callback handler
 */
class TronSignatureCallback extends Oracle {
    ...
    async hashLockTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        const _self = this;
        _self.logger.info(`TRON ${roleEnum} ${settlementId} hashLockTxSign sign_callback params: `, signedRawTransaction);
    ...
    async withdrawTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        const _self = this;
        _self.logger.info(`TRON ${roleEnum} ${settlementId} withdrawTxSign sign_callback params: `, signedRawTransaction);
    ...
    async refundTxSignCallback(roleEnum, settlementId, signedRawTransaction) {
        const _self = this;
        _self.logger.info(`TRON ${roleEnum} ${settlementId} refundTxSignCallback sign_callback params: `, signedRawTransaction);
...
module.exports = TronSignatureCallback;