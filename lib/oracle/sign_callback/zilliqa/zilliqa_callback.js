...
class ZilliqaSignatureCallback extends Oracle {
    ...
    async makerHashLockTxSignCallback(settlementId, signedRawTransaction) {
        this.print('Zilliqa makerHashLockTxSign sign_callback params: ', {settlementId, signedRawTransaction});
    ...
    async takerHashLockTxSignCallback(settlementId, signedRawTransaction) {
        this.print('Zilliqa takerHashLockTxSign sign_callback params: ', {settlementId, signedRawTransaction});
    ...
    async makerWithdrawTxSignCallback(settlementId, signedRawTransaction) {
        this.print('Zilliqa makerWithdrawTxSign sign_callback params: ', {settlementId, signedRawTransaction});
    ...
    async takerWithdrawTxSignCallback(settlementId, signedRawTransaction) {
        this.print('Zilliqa takerWithdrawTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async makerRefundTxSignCallback(settlementId, signedRawTransaction) {
        this.print('Zilliqa makerRefundTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async takerRefundTxSignCallback(settlementId, signedRawTransaction) {
        this.print('Zilliqa takerRefundTxSignCallback sign_callback params: ', {
            settlementId,
            signedRawTransaction
        });
