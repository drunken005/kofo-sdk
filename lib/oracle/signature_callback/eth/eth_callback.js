...
class EthSignatureCallback extends Oracle {
    ...
    async makerHashLockTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH makerHashLockTxSign signature_callback params: ', {settlementId, signedRawTransaction});
        ...
        try {
            ...
            console.log('============================================')
            console.log({lockId, rawTransaction, blockHeight, nLockNum});
    ...
    async takerHashLockTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH takerHashLockTxSign signature_callback params: ', {settlementId, signedRawTransaction});
    ...
    async makerWithdrawTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH makerWithdrawTxSign signature_callback params: ', {settlementId, signedRawTransaction});
    ...
    async takerWithdrawTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH takerWithdrawTxSignCallback signature_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async makerRefundTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH makerRefundTxSignCallback signature_callback params: ', {
            settlementId,
            signedRawTransaction
        });
    ...
    async takerRefundTxSignCallback(settlementId, signedRawTransaction) {
        this.print('ETH takerRefundTxSignCallback signature_callback params: ', {
            settlementId,
            signedRawTransaction
        });
