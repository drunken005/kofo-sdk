...
class Settlement extends Connection {
    ...
    async takerSubmitHashLockCallback(chain, settlementId, takerLockId, takerHashLockRawtransation, takerHashLockTransactionId, takerRefundThresholdBlockNum, takerLockExpireDate, signature = null) {
        this.print('Taker submit hash lock callback status server', {chain, settlementId, takerLockId, takerHashLockRawtransation, takerHashLockTransactionId, takerRefundThresholdBlockNum, takerLockExpireDate, signature});
        return true
    ...
    async makerSubmitWithdrawCallback(chain, makerWithdrawTransactionId, settlementId, signature = null) {
        this.print('Maker submit withdraw callback status server', {chain, makerWithdrawTransactionId, settlementId, signature});
        return true
    ...
    async takerSubmitWithdrawCallback(chain, takerWithdrawTransactionId, settlementId, signature = null) {
        this.print('Taker submit withdraw callback status server', {chain, takerWithdrawTransactionId, settlementId, signature});
        return true
    ...
    async makerSubmitRefundCallback(chain, settlementId, makerRefundTransactionId, signature = null) {
        this.print('Maker submit refund callback status server', {chain, settlementId, makerRefundTransactionId, signature});
        return true
    ...
    async takerSubmitRefundCallback(chain, settlementId, takerRefundTransactionId, signature = null) {
        this.print('Taker submit refund callback status server', {chain, settlementId, takerRefundTransactionId, signature});
        return true
    ...
    async makerSubmitApproveCallback(chain, settlementId, makerApproveTransactionId, signature = null) {
        this.print('Maker submit approve callback status server', {chain, settlementId, makerApproveTransactionId, signature});
        return true
    ...
    async takerSubmitApproveCallback(chain, settlementId, takerApproveTransactionId, signature = null) {
        this.print('Taker submit approve callback status server', {chain, settlementId, takerApproveTransactionId, signature});
        return true
